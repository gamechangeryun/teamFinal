...
public interface PronoticeService {
	public List<PronoticeDTO> getList(int startRow, int endRow, int lecture_num);	// 글 목록 가져오기
	public List<PronoticeDTO> getSearchList(int options, String searchContent, int startRow, int endRow, int lecture_num);	// 서치된 글 목록 가져오기
