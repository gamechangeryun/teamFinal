...
public class AttenDTO {
	...
	private int max_checkin;
	private int now_checkin;
	...
	public void setMax_checkin(int max_checkin) {
		this.max_checkin = max_checkin;
	}
	public int getNow_checkin() {
		return now_checkin;
	}
	public void setNow_checkin(int now_checkin) {
		this.now_checkin = now_checkin;
	}
	public List<AttenDTO> getList() {
		return list;
	}
	public void setList(List<AttenDTO> list) {
		this.list = list;
	}
	
	@Override
	public String toString() {
		return "AttenDTO [lecture_num=" + lecture_num + ", lecture_title=" + lecture_title + ", temper_name="
				+ temper_name + ", name=" + name + ", id=" + id + ", day=" + day + ", day1=" + day1 + ", day2=" + day2
				+ ", day3=" + day3 + ", day4=" + day4 + ", day5=" + day5 + ", day6=" + day6 + ", day7=" + day7
				+ ", day8=" + day8 + ", day9=" + day9 + ", day10=" + day10 + ", day11=" + day11 + ", day12=" + day12
				+ ", day13=" + day13 + ", day14=" + day14 + ", day15=" + day15 + ", day16=" + day16 + ", day17=" + day17
				+ ", day18=" + day18 + ", day19=" + day19 + ", day20=" + day20 + ", day21=" + day21 + ", day22=" + day22
				+ ", day23=" + day23 + ", day24=" + day24 + ", day25=" + day25 + ", day26=" + day26 + ", day27=" + day27
				+ ", day28=" + day28 + ", day29=" + day29 + ", day30=" + day30 + ", day31=" + day31 + ", max_checkin="
				+ max_checkin + ", now_checkin=" + now_checkin + ", list=" + list + "]";
	}
}
