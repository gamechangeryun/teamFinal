...
public class DownloadView extends AbstractView{
	/*
	 ...
	 requestUri 에 따라 Controller 로 분기를 하고, 비지니스 로직 처리 후 Resolver 를 사용하여 
	 해당 JSP 파일을 찾아 응답 하게 되는대 그 사이의 시점을 잡아 처리 하는 부분이 AbstractView 의 기능이다.
	*/
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// content-disposition:다운로드받을 파일의 이름
		// attachment:다운로드 되는걸 보여준다.	
