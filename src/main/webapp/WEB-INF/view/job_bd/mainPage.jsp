...
<body>
	...
	<form>
		<table border="1">
				...
				<c:if test="${mainList.size() > 0}">
					<tr>
						...
						<tr>
							...
							<img src="jobBoard/${item.fakename}" width="200" height="300"/>
							</a>
							</td>
							<td>${item.name}</td>
			...
			<tr>
				<td colspan="5"><input type="button" value="글쓰기" onclick="location.href='/FinalProject/job_bd/insertContentForm.do'" >
					<input type="button" value="전체글보기" onclick="location.href='/FinalProject/job_bd/board.do'" >
					<input type="button" value="돌아가기" onclick="location.href='/FinalProject/job_bd/turn.do'" >
				</td>
			</tr>
