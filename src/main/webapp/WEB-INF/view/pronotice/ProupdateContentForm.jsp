...
<body>
	...
	<form name="myform" action="/FinalProject/ProupdateContent.do" method="post" onsubmit="return checkIt()">
		...
		<table border="1">
			...
			<tr>
				<td>강의번호</td>
				<td><input type="number" name="lecture_num" value="${detailContent.lecture_num }" /></td>
			</tr>   
