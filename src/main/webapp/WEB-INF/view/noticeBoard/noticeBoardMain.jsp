...
<body>
	...
	<form>
		<table border="1">
						...
						<c:forEach var="item" items="${mainList }">
							<c:if test="${item.isnotice == 1 }">
								<tr>
									...
									<td><strong><a href="/FinalProject/detailContent.do?num=${item.num}">[공지]${item.title }</a></strong></td>
			...
			<tr>
				<td colspan="5"><input type="button" value="글쓰기" onclick="location.href='/FinalProject/insertContentForm.do'" >
					<input type="button" value="전체글보기" onclick="location.href='/FinalProject/noticeBoardMain.do'" >
