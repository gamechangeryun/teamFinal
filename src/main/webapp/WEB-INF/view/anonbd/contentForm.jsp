...
<body>
	<h2>게시글</h2>
	<hr>
	<form name="showContent" id="showContent" method="post">
		<table border="1">
			<tr>
				<th>글번호</th>
				<th>
		...
		<button type="button" id="deleteContent">삭제하기</button>
		...
		<table border="1">
			...
			<tr>
				<th>
					<input type="text" name="content" id="content" width="30" placeholder="댓글내용">
				</th>
				<th>
					<input type="text" name="comment_writer" id="comment_writer" placeholder="작성자(익명)">
				</th>
				<th>
					<button type="button" id="insertComment">입력</button>
				</th>
			</tr>
			<tr>
				<th colspan="2">
			...
			<tr align="left">
				...
				<td>
					<button type="button" onclick="location.href='<%=cp%>/anon/deleteComment.do?num=${content.num}&comment_num=${comment.comment_num}'">삭제</button>
				</td>
				<!-- 
